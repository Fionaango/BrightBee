    ...
    <LinearGradient colors={['#FFF1CC', '#FFFFFF']} style={styles.gradientBackground}>
      <SafeAreaView style={styles.safeArea}>
        <ScrollView contentContainerStyle={styles.container}>
          ...
          {/* Preferences Section with inline row for Notifications */}
          <View style={styles.section}>
...
const styles = StyleSheet.create({
  ...
  container: {
    padding: 20,
    backgroundColor: 'transparent', // gradient provides background
    alignItems: 'center',
  },
  title: {
    fontSize: 28,
  ...
  sectionTitle: {
    fontSize: 18,
    fontWeight: '600',
    color: '#FFC700', // Yellow accent for section headers
    marginBottom: 10,
    paddingHorizontal: 5,
    borderBottomWidth: 1,
  ...
  card: {
    ...
    width: '100%',
    borderWidth: 1,
    borderColor: '#FFC700', // Yellow border accent
    shadowColor: '#000',
